package com.in28minutes.microservices.mlagenteval.common.cache;
...
public abstract class GuavaCache<K, V> {
    ...
    public GuavaCache(long defaultMaximumSize, long defaultExpire, GuavaRefreshEnum expireAfterWrite) {
        this.maximumSize = defaultMaximumSize;
        this.expireDuration = defaultExpire;
        this.guavaFreshEnum = expireAfterWrite;
    }
